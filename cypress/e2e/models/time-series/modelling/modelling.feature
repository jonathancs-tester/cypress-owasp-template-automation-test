...
Feature: Modeling - Send your project
	...
	Scenario Outline: Modeling datasets with Feature Selection from UI
		...
		And I select "<g.variables>" options in element "Golden Variable Select"
		And I click the "Fine Tunning Confirm Button"
		And I close the "Modal N Windows OK Button" if exists
		And I click the "Modeling Button"
		And I can see text "You'll receive an email informing when the job is finished." in element "Modeling Description Modal"
		And I close the "Modeling Modal" if exists
		...
		Examples:
			...
			| UI_FS_Mensal_Sanity_1    | time-series/Mensal/dataset_fs_mensal_fake_3.xlsx | do not set | 12            | 2            | 12          | 2          | checked   | unchecked | RMSE     | Median | unchecked | unchecked | checked | brl_usd_lag1;brl_eur_lag1 | do not set        | do not set  | checked | checked   | unchecked   | price_feedstock_3_lag3 |
	...
	Scenario Outline: Check send variables Feature Store to Faas and modeling project
		...
		And I set "Select One Checkbox[name=igp-m---índice-geral-de-preços]" to checked
		And I click the "Add Button[position=first]"
		And I close the "Modeling Modal" if exists
		And I click the "Final Settings Button"
		And I wait for element "Custom Period Toggle" be enabled
		And I close the "Feature Selection Modal" if exists
		And I close the "Data Processing Modal" if exists
		Then I click the "Modeling Button"
		And I can see text "You'll receive an email informing when the job is finished." in element "Modeling Description Modal"
		And I close the "Modeling Modal" if exists

		Examples:
			| ProjectName              | dataset                                       |
			| UI_FS_Mensal_Variables_1 | time-series/Mensal/dataset_mensal_fake_1.xlsx |
	...
	@ALGORITMOTEAM
	Scenario Outline: Modeling project from Algorithm Team
		When upload dataset '<dataset>' with '<ProjectName>' project name
		And select variables with '<dateFormat>' date format
		And validate dataset
		Then send modeling with configs '<forestValue>', '<crossValue>', '<log>', '<dummies>', '<i.crit>', '<accuracy>', '<cross>', '<avoid>', '<auto_expl>', '<group 1>', '<group 2>', '<group 3>', '<lasso>', '<random>', '<correlation>', '<goldenVar>'
		...
		Examples:
			| ProjectName | dataset                                     | dateFormat | forestValue | crossValue | log  | dummies | i.crit | accuracy | cross  | avoid | auto_expl | group 1    | group 2    | group 3    | lasso | random | correlation | goldenVar  |
			| teste_wmape | algorithm/teste_wmape.xlsx                  | yyyy-MM-dd | 1           | 6          | True | True    | AIC    | WMAPE    | Median | False | True      | do not set | do not set | do not set | True  | True   | True        | do not set |
			| ts1029      | algorithm/ts1029_mensal_qtde_wolverine.xlsx | yyyy-MM-dd | 1           | 6          | True | True    | AIC    | MAPE     | Mean   | True  | False     | do not set | do not set | do not set | True  | True   | True        | do not set |


	Scenario Outline: Modeling for Validate Algorithm Tests via Base64
		When send a modeling "<file>" in "<version>" API

		Examples:
			| version | file                                                                |
			| v1      | time-series/algorithm/b64rm_anual_acuracia_mediana                  |
			| v1      | time-series/algorithm/b64rm_anual_exclusion                         |
			| v1      | time-series/algorithm/b64rm_anual_golden                            |
			| v1      | time-series/algorithm/b64rm_anual_lags                              |
			| v1      | time-series/algorithm/b64rm_anual_semexplicativa_peq                |
			| v1      | time-series/algorithm/b64rm_anual_valoresgrandes_semlog             |
			| v1      | time-series/algorithm/b64rm_bim_config_padrao                       |
			| v1      | time-series/algorithm/b64rm_bim_linhas_faltantes                    |
			| v1      | time-series/algorithm/b64rm_bim_linhasfaltantes_exclusion           |
			| v1      | time-series/algorithm/b64rm_bim_linhasfaltantes_golden              |
			| v1      | time-series/algorithm/b64rm_bim_linhasfaltantes_lags                |
			| v1      | time-series/algorithm/b64rm_bim_logfalse_mediana                    |
			| v1      | time-series/algorithm/b64rm_bim_pequeno                             |
			| v1      | time-series/algorithm/b64rm_bim_semexpli_nstepsewindows1            |
			| v1      | time-series/algorithm/b64rm_bim_semexplicativa                      |
			| v1      | time-series/algorithm/b64rm_diario_dummies_sazonais                 |
			| v1      | time-series/algorithm/b64rm_diario_exclusion                        |
			| v1      | time-series/algorithm/b64rm_diario_gapy_lagsdataset                 |
			| v1      | time-series/algorithm/b64rm_diario_golden                           |
			| v1      | time-series/algorithm/b64rm_diario_lags                             |
			| v1      | time-series/algorithm/b64rm_diario_muitas_dummies                   |
			| v1      | time-series/algorithm/b64rm_diario_muitos_outliers                  |
			| v1      | time-series/algorithm/b64rm_diario_muitoszeros_e_dummies            |
			| v1      | time-series/algorithm/b64rm_diario_semexplicativa_logseasd_t        |
			| v1      | time-series/algorithm/b64rm_diario_semexplicativa_numinteiros       |
			| v1      | time-series/algorithm/b64rm_diario_semexplicativa_peq               |
			| v1      | time-series/algorithm/b64rm_diario_y_num_inteiros                   |
			| v1      | time-series/algorithm/b64rm_mensal_exclusion                        |
			| v1      | time-series/algorithm/b64rm_mensal_golden                           |
			| v1      | time-series/algorithm/b64rm_mensal_grande_muitascolunas             |
			| v1      | time-series/algorithm/b64rm_mensal_lags                             |
			| v1      | time-series/algorithm/b64rm_mensal_linhasfaltantes_pmc              |
			| v1      | time-series/algorithm/b64rm_mensal_linhasfaltantes_caged            |
			| v1      | time-series/algorithm/b64rm_mensal_log_false                        |
			| v1      | time-series/algorithm/b64rm_mensal_pequeno_pandemia                 |
			| v1      | time-series/algorithm/b64rm_mensal_pequeno_sazonal                  |
			| v1      | time-series/algorithm/b64rm_mensal_pequeno_wmape_median             |
			| v1      | time-series/algorithm/b64rm_mensal_seas_marcada_ipca                |
			| v1      | time-series/algorithm/b64rm_mensal_seas_marcada_log_false           |
			| v1      | time-series/algorithm/b64rm_mensal_seas_marcada_log_true            |
			| v1      | time-series/algorithm/b64rm_quin_golden                             |
			| v1      | time-series/algorithm/b64rm_quin_lags                               |
			| v1      | time-series/algorithm/b64rm_quin_log_e_seasd_false                  |
			| v1      | time-series/algorithm/b64rm_quin_muitaslinhas_semexpli              |
			| v1      | time-series/algorithm/b64rm_quin_pequeno_log_e_seasd_false          |
			| v1      | time-series/algorithm/b64rm_quin_pequeno_nstepsewindows1            |
			| v1      | time-series/algorithm/b64rm_semanal_exclusion                       |
			| v1      | time-series/algorithm/b64rm_semanal_golden                          |
			| v1      | time-series/algorithm/b64rm_semanal_grande_muitascolunas_logseasd_f |
			| v1      | time-series/algorithm/b64rm_semanal_grande_muitascolunas_logseasd_t |
			| v1      | time-series/algorithm/b64rm_semanal_grande_semexplicativas_gap      |
			| v1      | time-series/algorithm/b64rm_semanal_lags                            |
			| v1      | time-series/algorithm/b64rm_semanal_linhasfaltantes                 |
			| v1      | time-series/algorithm/b64rm_semanal_padrão                          |
			| v1      | time-series/algorithm/b64rm_semanal_pequeno_muitascolunas           |
			| v1      | time-series/algorithm/b64rm_semestral_exclusion                     |
			| v1      | time-series/algorithm/b64rm_semestral_golden                        |
			| v1      | time-series/algorithm/b64rm_semestral_lags                          |
			| v1      | time-series/algorithm/b64rm_semestral_log_e_seasd_false             |
			| v1      | time-series/algorithm/b64rm_semestral_logfalse                      |
			| v1      | time-series/algorithm/b64rm_semestral_pequeno                       |
			| v1      | time-series/algorithm/b64rm_semestral_semexplicativa                |
			| v1      | time-series/algorithm/b64rm_trim_gapy                               |
			| v1      | time-series/algorithm/b64rm_trim_linhasfaltantes_logeseasd_false    |
			| v1      | time-series/algorithm/b64rm_trim_linhasfaltantes_nstepsewindows1    |
			| v1      | time-series/algorithm/b64rm_trim_muitascolunas_pim                  |
			| v1      | time-series/algorithm/b64rm_trim_muitascolunas_exclusion            |
			| v1      | time-series/algorithm/b64rm_trim_muitascolunas_golden               |
			| v1      | time-series/algorithm/b64rm_trim_muitascolunas_lags                 |
			| v1      | time-series/algorithm/b64rm_trim_muitascolunas_seasdfalse           |
			| v1      | time-series/algorithm/b64rm_trim_muitaslinhas_semexplicativa        |
			| v1      | time-series/algorithm/b64rm_trim_semexplicativa_peq                 |
	...
	@API @TS-65 @TS-73 @TS-128 @TS-279 @TS-330 @TS-854 @CS-497 @TS-1044
	Scenario Outline: Modeling project from Base64
		...
		Examples:
			...
			| v1      | time-series/b64rm_FS_pim_mar2002                          |
			| v1      | time-series/b64rm_ts1061-Ljung-Box-Value                  |
			| v1      | time-series/b64rm_diario_sem_sabado_domingo               |
			| v1      | time-series/b64rm_Dataset-Diario_170_mixed_obser          |
			| v1      | time-series/b64rm_Dataset-Diario_170_obser                |
			| v1      | time-series/b64rm_upt_stl_arim_univ                       |
			| v1      | time-series/incident_cpu-98Ys                             |
			| v1      | time-series/b64rm_teste_mdias_dataset_70y_168977641102799 |
			| v1      | time-series/b64rm_All_Mensal_modelling                    |
			| v1      | time-series/b64rm_All_Mensal_partial_success_modelling    |
			| v1      | time-series/b64rm_ts1009_ar_univ_nivel_comb_logT          |
			| v1      | time-series/b64rm_cs_497_upt_mult_y_nomes_parecidos       |
			| v1      | time-series/b64rm_ts1044_l1_z_variable                    |
